                ...
                <div style="background-color: white; margin: 40px">
                  ...
                  <div style="text-align: left; margin-top: 30px;">
                    <p style="font-size: 20px; color: rgb(80,80,80); margin-top: 0px;">
                      ...
                      You have officially started your Premium plan with the following modules:
                      <strong>${formatter.capitalize(module)}</strong>.
                    </p>
                    <p style="font-size: 20px; color: rgb(80,80,80); margin-top: 0px;">
                    Your plan includes:
                    </p>
                    ...
                    <div style="display: flex; margin-top: 20px; margin-bottom: 0px;">
                      <img style="width: 30px; height: 30px; vertical-align:text-top;" src="${OFFICIAL_WEBSITE_URL}/team-icon.png"/>
                      <span style="margin-left: 10px; font-size: 20px; color: rgb(80,80,80);">
                        Subscriptions with multiple users (team)
                      </span>
                    </div>
...
module.exports = (name, module) => html(name, module);
